    ...
    <footer className="bg-black text-white py-10 border-t border-gray-800">
      <div className="flex flex-col items-center gap-4">
        <div className="flex gap-6 text-2xl">
          ...
          <a href="mailto:jorgebernardolanga@email.com" className="hover:text-blue-400 transition-colors">
        ...
        <p className="text-sm text-gray-400">Desenvolvido por <span className="font-bold text-white">JBL</span> &copy; {new Date().getFullYear()}</p>
      </div>
    </footer>
  );
};
